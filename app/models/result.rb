...
attr_accessible :id, :real_price, :escore, :start_date_time, :end_date_time, :start_date, :end_date, :start_time, :end_time, :stops, :price_tag, :transit_time, :start_location, :end_location, :position
